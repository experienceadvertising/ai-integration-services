...
export const industries: IndustryData[] = [
  ...
  },
  {
    ...
    metaTitle: "Claude Cowork Training for Financial Services | AI for Advisors",
    metaDescription: "AI training for financial advisors, CPAs, and accounting firms — automate client reports, portfolio summaries, tax prep workflows, and compliance docs.",
  ...
  },
  {
    ...
    metaDescription: "AI training for medical offices and healthcare teams — automate patient communications, referral letters, intake processing, and admin workflows.",
  ...
  },
  {
    ...
    metaTitle: "Claude Cowork Training for E-Commerce & Retail | AI for Stores",
    metaDescription: "AI training for e-commerce teams — automate product descriptions, customer support responses, email campaigns, and competitor analysis with Claude Cowork.",
  ...
  },
  {
    ...
    metaDescription: "AI training for HR teams and recruiting agencies — automate job descriptions, candidate summaries, offer letters, onboarding docs, and policy writing.",
    badge: "HR & Recruiting",
  ...
  },
  {
    ...
    metaDescription: "AI training for insurance agents and teams — automate policy comparisons, client communications, renewal sequences, claims correspondence, and compliance docs.",
    badge: "Insurance",
  ...
  },
  {
    ...
    metaDescription: "AI training for nonprofits — automate grant writing, donor communications, program reports, annual reports, and volunteer coordination with Claude Cowork.",
    badge: "Nonprofit",
